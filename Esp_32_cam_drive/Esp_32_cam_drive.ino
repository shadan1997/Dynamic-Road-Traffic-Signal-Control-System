...
const char* ssid = "Shadan 2.4";		//your network SSID
const char* password = "*******" 	//your network password

String myScript = "/macros/s/AKfycbyN2WBb3C6U-gElxGEFBA-mbMGe1aBhD-R635QuBBCVu55hRIcx/exec";    //Create your Google Apps Script and replace the "myScript" path.
